...
string path = string(PROJECT_DIR_PATH) + "/resource/image/image-yuv420p-800x450.yuv";
//string path = string(PROJECT_DIR_PATH) + "/resource/image/image-yuv420p-640x426.yuv";
#endif
