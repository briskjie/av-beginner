...
FFmpegYuvToH264::FFmpegYuvToH264():mInputFilePath(""),mOutputFilePath(""),mWidth(-1),mHeight(-1) {

}

int FFmpegYuvToH264::initContext() {
    av_register_all();
...
int FFmpegYuvToH264::open(string input, string output, int width, int height) {
...
int FFmpegYuvToH264::initBuffer() {
...
int FFmpegYuvToH264::writeHeader() {
...
int FFmpegYuvToH264::encodeData() {
...
int FFmpegYuvToH264::writeTrailer() {
    av_write_trailer(pFormatCtx);
    return 0;
}

FFmpegYuvToH264::~FFmpegYuvToH264() {
    if (video_st){
