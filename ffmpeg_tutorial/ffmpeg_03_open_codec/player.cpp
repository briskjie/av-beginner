...
Player::Player(string path) : mPath(path) {
...
int Player::openInputFile(AVFormatContext *&fmt_ctx, const char *filename) {
...
int
Player::openCodecContext(int &stream_idx, AVCodecContext *&codec_ctx,
